# DisplayName: Jolla surnia/@ARCH@ (release) 1
...
repo --name=adaptation0-surnia-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-motorola-surnia/@ARCH@/
...
%packages
@Jolla Configuration surnia
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/surnia
